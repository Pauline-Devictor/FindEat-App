...
public class RestaurationFactory extends LieuxFactory {
    ...
    public Lieux build(int type,String name, String placeID, boolean openNow, String picture, double rate, double longitude, double latitude, Integer priceLevel) throws Throwable{
        switch (type){
